    ...
    if (!isSignInForm) {
      ...
      createUserWithEmailAndPassword(
        ...
        .then((userCredential) => {
          ...
          updateProfile(user, {
            displayName: name?.current?.value, photoURL: "https://yt3.ggpht.com/yti/ANjgQV8kEukZIXerCWCeTQjjRouh-Yb6FKm4HqQT9wihX-_0xpU=s88-c-k-c0x00ffffff-no-rj"
          }).then(() => {
            // Profile updated!
            // ...
  ...
  return (
    <div>
      ...
      >
        ...
        />
        {!!errorMsg ? (
          <p className="w-full p-2 mb-5 text-red-700">{errorMsg}</p>
        ) : null}
        <button
          className="p-4 m-2 mb-10 w-full font-bold bg-red-700 rounded-lg text-lg"
